...
public class CrawlerBehavior : MonoBehaviour
{
    ...
    private IEnumerator waitToMove()
    {
        ...
        float distance;
        playerMaisPerto = playerPiecesPositions[0];
    ...
    IEnumerator waitToAttack()
    {
        ...
        Instantiate(cellToAttack, new Vector2(transform.position.x - 1, transform.position.y + 1), Quaternion.identity, gameObject.transform);
        Instantiate(cellToAttack, new Vector2(transform.position.x - 1, transform.position.y - 1), Quaternion.identity, gameObject.transform);
        Instantiate(cellToAttack, new Vector2(transform.position.x - 2, transform.position.y + 2), Quaternion.identity, gameObject.transform);
        Instantiate(cellToAttack, new Vector2(transform.position.x - 2, transform.position.y - 2), Quaternion.identity, gameObject.transform);
        Instantiate(cellToAttack, new Vector2(transform.position.x + 2, transform.position.y + 2), Quaternion.identity, gameObject.transform);
        Instantiate(cellToAttack, new Vector2(transform.position.x + 2, transform.position.y - 2), Quaternion.identity, gameObject.transform);
